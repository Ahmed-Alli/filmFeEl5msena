...
class FilmAdapter(
    private val postList: ArrayList<FilmItem>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):RecyclerView.ViewHolder {
        ...
        return if (viewType == CONTENT_VIEW) {
            view = LayoutInflater.from(context).inflate(R.layout.film_card, parent, false)
            ContentHolder(view)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (getItemViewType(position) == CONTENT_VIEW) {
            ...
            contentHolder.cardItem.animation =
                AnimationUtils.loadAnimation(holder.itemView.context, R.anim.recycler_view_background)
            ...
            val adLoader = AdLoader.Builder(
                context, "ca-app-pub-3145576516793733/9929359083"
