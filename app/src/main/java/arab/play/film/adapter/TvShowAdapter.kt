...
class TvShowAdapter(
    ...
    inner class ContentHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var textView7:TextView =itemView.findViewById(R.id.textView7)
        var textView8:TextView =itemView.findViewById(R.id.textView8)
        var textView11:TextView =itemView.findViewById(R.id.textView11)
        var img4:TextView =itemView.findViewById(R.id.textView12)
        ...
        var story:TextView =itemView.findViewById(R.id.textView15)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (getItemViewType(position) == CONTENT_VIEW) {
            ...
            val adLoader = AdLoader.Builder(
                context, "ca-app-pub-3145576516793733/6687870654"
